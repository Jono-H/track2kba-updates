...
## SCRIPT PURPOSE:
## This script relies on an offline version of track2kba. SEE: 
## track2KBA GitHub account: https://github.com/BirdLifeInternational/track2kba
## Supported by the manuscript Beal et al. 2021

## Downloaded on 11 March 2023

## The script aims to support modifying functions relying on R packages that will
## become retired soon: rgdal, rgeos, maptools.
...
## Working directory: I am working in an R project structure on my personal machine
...
"Continue from here as of 17 March 2023 @ 17:38"
